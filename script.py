...
def usage():
    print ("Script Tool Net")
    print ()
    print ("Usage: script.py -t target_host -p port")
    ...
    print ()
    print ("Examples: ")
    print ("script.py -t 192.168.0.1 -p 5555 -l -c")
    print ("script.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print ("script.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print ("echo 'ABCDEFGHI' | ./script.py -t 192.168.11.12 -p 135")
    sys.exit(0)

def run_command(command):
    # remove a quebra de lina
